...
public final class Authentication {
    ...
    public static func authenticate(
        ...
        twoFactorAttempt: Int = 0
    ) async throws -> (Account, AppleAPISession) {
        guard twoFactorAttempt <= 1 else {
            throw AppleAPIError.customError(code: -1, message: "Apple requested 2FA again after verification. Stop and sign in again with fresh local Anisette data.")
        }
    ...
    public static func sendAuthenticationRequest(
        ...
        guard errorCode == 0 else {
            ...
            default:
                ...
                let localizedDescription = "Apple authentication rejected the request."
    ...
    public static func requestTrustedDeviceTwoFactorCode(
        ...
        guard errorCode == 0 else {
            ...
            default:
                ...
                throw AppleAPIError.customError(code: errorCode, message: "Apple rejected the verification code.")
            }
        }
    }
    ...
    public static func requestSMSTwoFactorCode(
        ...
        guard let httpResponse = response as? HTTPURLResponse,
              ...
              httpResponse.value(forHTTPHeaderField: "X-Apple-PE-Token") != nil
        else {
            throw AppleAPIError.incorrectVerificationCode
        }
    }
